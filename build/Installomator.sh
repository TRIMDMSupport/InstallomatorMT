...
displaylinkmanager)
    ...
    downloadURL="https://www.synaptics.com/sites/default/files/exe_files/2026-04/DisplayLink%20Manager%20Graphics%20Connectivity16.0-EXE.pkg"
    appNewVersion="16.0.16"
...
sqldeveloper)
    ...
    appNewVersion="24.3.1.347"
    expectedTeamID="VB5E2TV963"
    appCustomVersion(){ echo "$(defaults read /Applications/SQLDeveloper.app/Contents/Info.plist CFBundleVersion )" }
    ;;
stats)
    name="Stats"
    type="dmg"

...
item="example" # enter the software to install
...
getCustomInstallomator () {
    ...
    if ! curl -L -# --show-error 'https://raw.githubusercontent.com/TRIMDMSupport/InstallomatorMT/refs/heads/main/build/Installomator.sh' -o '/usr/local/Installomator/Installomator.sh' ; then

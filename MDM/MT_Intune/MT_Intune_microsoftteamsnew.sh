...
item="microsoftteamsnew" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://w7.pngwing.com/pngs/287/549/png-transparent-microsoft-team-social-network-management-business-icon.png"

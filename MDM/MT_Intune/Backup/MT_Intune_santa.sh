...
item="santa" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://static.macupdate.com/products/58136/l/santa-logo.png"
...
appPath="/Applications/Santa.app"
...
installomatorOptions="LOGGING=REQ BLOCKING_PROCESS_ACTION=ignore NOTIFY=silent" # Separated by space
...
installomatorOptions="LOGGING=DEBUG BLOCKING_PROCESS_ACTION=ignore NOTIFY=silent" # Separated by space

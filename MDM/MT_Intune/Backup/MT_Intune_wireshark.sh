...
item="wireshark" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://upload.wikimedia.org/wikipedia/commons/c/c6/Wireshark_icon_new.png"
...
appPath="/Applications/Wireshark.app"

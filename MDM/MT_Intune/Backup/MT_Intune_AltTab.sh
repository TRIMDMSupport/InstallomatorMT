...
item="alttab" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://alt-tab-macos.netlify.app/public/android-chrome-256x256.png"
...
appPath="/Applications/AltTab.app"
...
#installed file exist then exit

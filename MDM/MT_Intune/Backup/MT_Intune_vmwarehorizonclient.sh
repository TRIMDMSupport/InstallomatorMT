...
item="vmwarehorizonclient" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://cdn.icon-icons.com/icons2/3053/PNG/512/vmware_horizon_macos_bigsur_icon_189581.png"
...
appPath="/Applications/VMware Horizon Client.app"

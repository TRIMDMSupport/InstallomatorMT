...
item="acrobatreader_local" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://raw.githubusercontent.com/TRIMDMSupport/scriptdesign/refs/heads/main/icons/Acrobat-Reader-icon.png"
...
installomatorOptions="LOGGING=DEBUG BLOCKING_PROCESS_ACTION=prompt_user_loop DIALOG_CMD_FILE=${dialog_command_file} targetDir=/Applications/Adobe Acrobat DC" # Separated by space

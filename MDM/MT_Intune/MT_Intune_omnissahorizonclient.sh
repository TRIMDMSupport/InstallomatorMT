...
item="omnissahorizonclient" # enter the software to install
# Examples: adobecreativeclouddesktop, canva, cyberduck, handbrake, inkscape, textmate, vlc

# Dialog icon
icon="https://cloud.vmwarehorizon.com/appblast/endpoint/assets/horizon-icon.svg"
...
appPath="/Applications/Omnissa Horizon Client.app"
...
sudo rm -rf /usr/local/Installomator/installed/vmwarehorizonclient
#installed file exsist then exit
